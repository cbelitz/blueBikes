...
set.seed(1)
rf.trips = randomForest(flow~weekday+Name+District+Public+Total.docks+bikelanedist+tstopdist, data=trips_per_day_09_19, subset=train, mtry=6, ntree=25, importance=TRUE)
